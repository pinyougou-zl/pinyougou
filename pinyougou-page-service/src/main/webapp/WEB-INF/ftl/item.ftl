        ...
        <div class="product-info">
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="summary">
                    ...
                    <div id="two"class="tab-pane"><p>${tbGoodsDesc.packageList}</p></div>

                    <div id="three"class="tab-pane"><p>${tbGoodsDesc.saleService}</p></div>
                        <div class="fr remark">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a @click="addGoodsToCartList()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
